...
4. Do **not** commit your personal token.
...
git init
git add .
git commit -m "Initial TRMNL Google Fit connector"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/trmnl-google-fit-connector.git
...
- Your deployed `/exec` URL with token
- Your `TRMNL_TOKEN`
- Screenshots containing your token
- Google Cloud client secrets
- Private logs showing personal health data
